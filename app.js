...
const MENU = [
  ...
  /* 17/07/2026 · "Actualizar datos" SE SUPRIME del inicio (lo pidió el usuario).
     La vista y su ruta #/datos siguen vivas por si alguien la tiene guardada,
     pero ya nada la enlaza. */
...
const IMPLEMENTADAS = new Set(['tarjeta', 'datos', 'solicitud', 'ideas', 'refiere', 'lideres', 'comercio', 'noticias', 'casa', 'emergencia']);   // 'datos' se queda: la ruta funciona aunque ya no tenga baldosa
